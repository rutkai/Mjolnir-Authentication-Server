...
function getUserId(username) {
    ...
    findUser(username, function (user) {
        id = createSelectedProfileFromId(user.id);
    });
...
function sessionJoin(accessToken, selectedProfile, serverId) {
    ...
    findUser(accessToken, 'accessToken', function (user, driver) {
        if (selectedProfile !== createSelectedProfileFromId(user.id)) {
            return;
        }
...
function sessionHasJoined(username, serverId) {
    var result = false;

    findUser(username, 'playerName', function (user) {
...
function createSelectedProfileFromId(userId) {
